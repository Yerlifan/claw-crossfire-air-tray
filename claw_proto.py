...
Paket (17 bayt, çıkış raporu ve giriş raporu aynı biçimde):
  ...
  [5]=uzunluk (<=10)      [6..15]=veri           [16]=sağlama, sağlama = (0x55 - toplam(bayt 0..15)) & 0xFF
Komutlar: 0x03 çevrimiçi, 0x04 pil, 0x07 flash yaz, 0x08 flash oku, 0x12 sürüm,
          0x16 / 0x17 uzun menzil yaz / oku.
Flash'ta her tek baytlık ayar (değer, sağlama) çifti olarak saklanır, sağlama = (0x55 - değer) & 0xFF;
çok baytlı gruplar sağlama = (0x55 - toplam) & 0xFF ile biter.
"""
import threading
import time
...
def write_byte(path, addr, val):
    """Tek baytlık ayar: (değer, sağlama) çiftini yazar, geri okuyup doğrular; sağlama = (0x55 - değer) & 0xFF."""
